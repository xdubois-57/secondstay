...
return [
    'pdf' => [
        ...
        'acceptance_notice' => 'De aanvaarding van deze overeenkomst wordt elektronisch vastgelegd, met datum, versie en taal.',
    ],
    'section' => [
        'parties' => 'De partijen',
        'property' => 'De woning',
    ...
    'clause' => [
        'cancellation' => [
            'title' => 'Annulering',
            'body' => 'De reiziger kan op elk moment annuleren. Reeds betaalde bedragen worden terugbetaald of ingehouden volgens de algemene voorwaarden die golden op de datum van de reservering, waarvan de versie hieronder staat. Annuleert de eigenaar, dan wordt alles wat betaald is volledig terugbetaald.',
        ],
        'inventory' => [
            'title' => 'Plaatsbeschrijving',
            'body' => 'Bij aankomst en bij vertrek wordt een plaatsbeschrijving opgemaakt. Blijft een opmerking van de reiziger binnen vierentwintig uur na aankomst uit, dan wordt de woning geacht overeen te stemmen met de plaatsbeschrijving bij aankomst.',
        ],
        'rules' => [
            'title' => 'Gebruik van de woning',
            'body' => 'De woning wordt gemeubileerd verhuurd, uitsluitend voor tijdelijke bewoning. Het aantal bewoners mag de vermelde capaciteit niet overschrijden. Onderverhuur is verboden.',
        ],
        'liability' => [
            'title' => 'Aansprakelijkheid en verzekering',
            'body' => 'De reiziger is aansprakelijk voor schade tijdens het verblijf en verklaart voor de duur van de huur verzekerd te zijn voor wettelijke aansprakelijkheid.',
        ],
        'data' => [
            'title' => 'Persoonsgegevens',
            'body' => 'De verzamelde gegevens dienen uitsluitend voor het beheer van de verhuur. De reiziger heeft recht op inzage, verbetering, overdraagbaarheid en verwijdering, uit te oefenen vanuit zijn persoonlijke omgeving.',
        ],
    ],
    'accept' => [
