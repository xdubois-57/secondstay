...
return [
    'pdf' => [
        ...
        'acceptance_notice' => 'L’acceptation de ce contrat est enregistrée par voie électronique, avec sa date, sa version et sa langue.',
    ],
    'section' => [
        'parties' => 'Les parties',
    ...
    'clause' => [
        'cancellation' => [
            'title' => 'Annulation',
            'body' => 'Le voyageur peut annuler à tout moment. Les sommes déjà versées sont restituées ou retenues selon les conditions générales en vigueur à la date de la réservation, dont la version est indiquée ci-dessous. En cas d’annulation par le propriétaire, l’intégralité des sommes versées est restituée.',
        ],
        'inventory' => [
            'title' => 'État des lieux',
            'body' => 'Un état des lieux est établi à l’arrivée et au départ. À défaut d’observation du voyageur dans les vingt-quatre heures suivant son arrivée, le logement est réputé conforme à l’état des lieux d’entrée.',
        ],
        'rules' => [
            'title' => 'Occupation du logement',
            'body' => 'Le logement est loué meublé, à usage exclusif d’habitation temporaire. Le nombre d’occupants ne peut excéder la capacité indiquée. La sous-location est interdite.',
        ],
        'liability' => [
            'title' => 'Responsabilité et assurance',
            'body' => 'Le voyageur répond des dommages causés pendant le séjour. Il déclare être couvert par une assurance de responsabilité civile pour la durée de la location.',
        ],
        'data' => [
            'title' => 'Données personnelles',
            'body' => 'Les informations recueillies servent exclusivement à la gestion de la location. Le voyageur dispose d’un droit d’accès, de rectification, de portabilité et de suppression, qu’il peut exercer depuis son espace personnel.',
        ],
    ],
    'accept' => [
