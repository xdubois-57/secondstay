...
return [
    ...
    'error' => [
        'media' => 'Le quota des médias est atteint. Libérez de l’espace ou augmentez la limite avant d’ajouter un fichier.',
        'documents' => 'Le quota des documents est atteint. Libérez de l’espace ou augmentez la limite avant d’ajouter un fichier.',
