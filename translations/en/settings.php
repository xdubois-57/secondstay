...
return [
    ...
    'booking' => [
        ...
        'requires_approval' => [
            ...
            'help' => 'Every booking request waits for your agreement. Turn this off to confirm available stays '
                . 'automatically.',
        ],
        'allow_waitlist' => [
            'label' => 'Waiting list',
    ...
    'scheduler' => [
        'http_token' => [
            ...
            'help' => 'Set this only if your host offers cron by URL alone. Left empty, the trigger URL does not '
                . 'exist.',
        ],
    ],
    'backup' => [
    ...
    'mail' => [
        ...
        'dkim_selector' => [
            'label' => 'DKIM selector',
            'help' => 'Selector provided by your sending service (often “default” or “mail”). It is only used for the '
                . 'DNS diagnostic: signing remains the provider’s responsibility.',
        ],
    ],
    'notification' => [
        'reminder_days' => [
    ...
    'push' => [
        'subject' => [
            'label' => 'Push contact',
            'help' => 'Contact email address or URL sent to push services, as the standard requires. The sender '
                . 'address is used when left empty.',
        ],
        'vapid_public' => [
            'label' => 'VAPID public key',
            'help' => 'Generated by the installation and handed to browsers. Replacing it invalidates every existing '
                . 'subscription.',
        ],
        'vapid_private' => [
    ...
    'payment' => [
        'provider' => [
            ...
            'help' => 'Mollie collects online and confirms the booking automatically. Without a provider, only bank '
                . 'transfer remains available.',
        ],
        'mollie_api_key' => [
    ...
    'imap' => [
        ...
        'uid_validity' => [
            ...
            'help' => 'Filled in by the sync. If it changes, the mailbox was renumbered and polling restarts from the '
                . 'beginning.',
        ],
        'batch_size' => [
    ...
    'pwa' => [
        'theme_color' => [
            'label' => 'Theme colour',
            'help' => 'Tint of the system bar once the app is installed. Format #rrggbb.',
        ],
        'background_color' => [
            'label' => 'Background colour',
            'help' => 'Shown at launch, before the first render. Format #rrggbb.',
        ],
    ],
    'quota' => [
